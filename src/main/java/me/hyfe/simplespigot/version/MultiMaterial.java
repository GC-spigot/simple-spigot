...
public enum MultiMaterial {
    ...
    ACACIA_LOG(Entry.of("LOG_2", 0, 4, 8)),
    ...
    COOKED_BEEF(),
    COOKED_CHICKEN(),
    COOKED_COD(Entry.of("COOKED_FISH", 0)),
    COOKED_MUTTON(),
    COOKED_PORKCHOP(),
    COOKED_RABBIT(),
    COOKED_SALMON(Entry.of("COOKED_FISH", 1)),
    COOKIE(),
    CORNFLOWER(),
    ...
    DARK_OAK_FENCE_GATE(),
    DARK_OAK_LEAVES(),
    DARK_OAK_LOG(Entry.of("LOG_2", 1, 5, 9)),
    DARK_OAK_PLANKS(),
    ...
    JUNGLE_FENCE_GATE(),
    JUNGLE_LEAVES(),
    JUNGLE_LOG(Entry.of("LOG", 3, 7, 11)),
    JUNGLE_PLANKS(),
    ...
    PRISMARINE_STAIRS(),
    PRISMARINE_WALL(),
    PUFFERFISH(Entry.of("RAW_FISH", 3)),
    PUFFERFISH_BUCKET(),
    ...
    TRIPWIRE(),
    TRIPWIRE_HOOK(),
    TROPICAL_FISH(Entry.of("RAW_FISH", 2)),
