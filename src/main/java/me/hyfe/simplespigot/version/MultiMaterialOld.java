...
public enum MultiMaterialOld {
    ...
    private Set<Integer> oldDatas = Sets.newHashSet(0);
    ...
    MultiMaterialOld(String oldMaterial) {
        this.oldMaterial = oldMaterial;
    }

    MultiMaterialOld(String oldMaterial, int... oldDatas) {
        this.oldMaterial = oldMaterial;
        this.oldDatas = Sets.newHashSet();
        for (int oldData : oldDatas) {
            this.oldDatas.add(oldData);
        }
    }

    MultiMaterialOld(String newMaterial, String oldMaterial) {
        this.newMaterial = newMaterial;
        this.oldMaterial = oldMaterial;
    }

    MultiMaterialOld(String newMaterial, String oldMaterial, int... oldDatas) {
        this.newMaterial = newMaterial;
        this.oldMaterial = oldMaterial;
        this.oldDatas = Sets.newHashSet();
        for (int oldData : oldDatas) {
    ...
    MultiMaterialOld(String oldMaterial, int oldData, String oldMaterial2) {
        this.oldMaterial = oldMaterial;
        this.oldDatas = Sets.newHashSet(oldData);
    ...
    public static ItemStack itemFrom(String item) {
        ...
        MultiMaterialOld multiMaterial = fromString(itemArray[0].toUpperCase(), data);
        return multiMaterial == null ? DIRT.getItem() : multiMaterial.getItem(1, data);
    }

    public static MultiMaterialOld fromString(String string) {
        return fromString(string, 0);
    }

    public static MultiMaterialOld fromString(String string, int data) {
        if (data != 0) {
    ...
    private static MultiMaterialOld search(String string, int data) {
            for (MultiMaterialOld multiMaterial : values()) {
    ...
    public static ImmutablePair<MultiMaterialOld, Byte> splitString(String string) {
        String[] split = string.split(":");
        byte data = split.length > 1 ? Byte.parseByte(split[1]) : 0;
        MultiMaterialOld multiMaterial = MultiMaterialOld.fromString(split[0], data);
    ...
    public int getData() {
        return (int) this.oldDatas.toArray()[0];
    }
