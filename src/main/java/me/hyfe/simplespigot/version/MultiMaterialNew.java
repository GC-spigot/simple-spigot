...
public enum MultiMaterialNew {
    ...
    CAVE_SPIDER_SPAWN_EGG(Entry.of("MOSTER_EGG", 59)),
    CHAIN(),
    CHAINMAIL_BOOTS(),
    ...
    CHEST_MINECART(),
    CHICKEN(),
    CHICKEN_SPAWN_EGG(Entry.of("MOSTER_EGG", 93)),
    CHIPPED_ANVIL(),
    ...
    COOKIE(),
    CORNFLOWER(),
    COW_SPAWN_EGG(Entry.of("MOSTER_EGG", 92)),
    ...
    CREEPER_HEAD(),
    CREEPER_SPAWN_EGG(Entry.of("MOSTER_EGG", 50)),
    CREEPER_WALL_HEAD(),
    CRIMSON_BUTTON(),
    CRIMSON_DOOR(),
    CRIMSON_FENCE(),
    ...
    ENCHANTING_TABLE(),
    ENDERMAN_SPAWN_EGG(Entry.of("MOSTER_EGG", 58)),
    ENDERMITE_SPAWN_EGG(Entry.of("MOSTER_EGG", 67)),
    ENDER_CHEST(),
    ENDER_EYE(),
    ENDER_PEARL(),
    END_CRYSTAL(),
    ...
    FURNACE(),
    FURNACE_MINECART(),
    GHAST_SPAWN_EGG(Entry.of("MOSTER_EGG", 56)),
    GHAST_TEAR(),
    GILDED_BLACKSTONE(),
    GLASS(),
    GLASS_BOTTLE(),
    ...
    GREEN_WOOL(),
    GRINDSTONE(),
    GUARDIAN_SPAWN_EGG(Entry.of("MOSTER_EGG", 68)),
    GUNPOWDER(),
    HAY_BLOCK(),
    HEART_OF_THE_SEA(),
    ...
    HORN_CORAL_FAN(),
    HORN_CORAL_WALL_FAN(),
    HORSE_SPAWN_EGG(Entry.of("MOSTER_EGG", 100)),
    HUSK_SPAWN_EGG(),
    ICE(),
    ...
    MAGMA_BLOCK(),
    MAGMA_CREAM(),
    MAGMA_CUBE_SPAWN_EGG(Entry.of("MOSTER_EGG", 62)),
    MAP(),
    MELON(),
    MELON_SEEDS(),
    MELON_SLICE(),
    ...
    MOOSHROOM_SPAWN_EGG(Entry.of("MOSTER_EGG", 96)),
    MOSSY_COBBLESTONE(),
    ...
    OBSERVER(),
    OBSIDIAN(),
    OCELOT_SPAWN_EGG(Entry.of("MOSTER_EGG", 98)),
    ORANGE_BANNER(),
    ORANGE_BED(),
    ORANGE_CARPET(),
    ORANGE_CONCRETE(),
    ...
    PIGLIN_SPAWN_EGG(Entry.of("MOSTER_EGG", 57)),
    PIG_SPAWN_EGG(Entry.of("MOSTER_EGG", 90)),
    PILLAGER_SPAWN_EGG(),
    PINK_BANNER(),
    PINK_BED(),
    PINK_CARPET(),
    ...
    RABBIT_FOOT(),
    RABBIT_HIDE(),
    RABBIT_SPAWN_EGG(Entry.of("MOSTER_EGG", 101)),
    RABBIT_STEW(),
    RAIL(),
    RAVAGER_SPAWN_EGG(),
    REDSTONE(),
    ...
    SEA_PICKLE(),
    SHEARS(),
    SHEEP_SPAWN_EGG(Entry.of("MOSTER_EGG", 91)),
    SHIELD(),
    SHROOMLIGHT(),
    SHULKER_BOX(),
    SHULKER_SHELL(),
    SHULKER_SPAWN_EGG(),
    SILVERFISH_SPAWN_EGG(Entry.of("MOSTER_EGG", 60)),
    SKELETON_HORSE_SPAWN_EGG(),
    SKELETON_SKULL(),
    SKELETON_SPAWN_EGG(Entry.of("MOSTER_EGG", 51)),
    SKELETON_WALL_SKULL(),
    SKULL_BANNER_PATTERN(),
    SLIME_BALL(),
    SLIME_BLOCK(),
    SLIME_SPAWN_EGG(Entry.of("MOSTER_EGG", 55)),
    SMITHING_TABLE(),
    SMOKER(),
    SMOOTH_QUARTZ(),
    SMOOTH_QUARTZ_SLAB(),
    ...
    SPECTRAL_ARROW(),
    SPIDER_EYE(),
    SPIDER_SPAWN_EGG(Entry.of("MOSTER_EGG", 52)),
    SPLASH_POTION(),
    SPONGE(),
    SPRUCE_BOAT(),
    SPRUCE_BUTTON(),
    ...
    SPRUCE_WALL_SIGN(),
    SPRUCE_WOOD(),
    SQUID_SPAWN_EGG(Entry.of("MOSTER_EGG", 94)),
    STICK(),
    STICKY_PISTON(),
    STONE(),
    STONECUTTER(),
    ...
    VEX_SPAWN_EGG(),
    VILLAGER_SPAWN_EGG(Entry.of("MOSTER_EGG", 120)),
    ...
    WHITE_WALL_BANNER(),
    WHITE_WOOL(),
    WITCH_SPAWN_EGG(Entry.of("MOSTER_EGG", 66)),
    WITHER_ROSE(),
    WITHER_SKELETON_SKULL(),
    WITHER_SKELETON_SPAWN_EGG(),
    WITHER_SKELETON_WALL_SKULL(),
    WOLF_SPAWN_EGG(Entry.of("MOSTER_EGG", 95)),
    WOODEN_AXE(),
    WOODEN_HOE(),
    WOODEN_PICKAXE(),
    WOODEN_SHOVEL(),
    ...
    ZOMBIE_SPAWN_EGG(Entry.of("MOSTER_EGG", 54)),
